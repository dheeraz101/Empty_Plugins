...
export function setup(api) {
  ...
  box.innerHTML = `
    <style>
      ...
      .about-label { font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.1em; color: #86868b; margin-bottom: 8px; }
      .about-title { font-size: 34px; font-weight: 700; letter-spacing: -0.02em; line-height: 1.1; color: #1d1d1f; }
      .about-subtitle { margin-top: 12px; font-size: 17px; color: #424245; line-height: 1.5; font-weight: 400; max-width: 90%; }
      ...
      .about-feature-card p { font-size: 13px; color: #6e6e73; margin: 0; line-height: 1.4; }
      ...
      .about-close:hover { background: #0077ed; transform: scale(1.02); }

      @media (prefers-color-scheme: dark) {
        .plugin-box { background: rgba(28, 28, 30, 0.7); color: #fff; border: 1px solid rgba(255, 255, 255, 0.1); }
        .about-title { color: #f5f5f7; }
        .about-subtitle { color: #a1a1a6; }
        .about-feature-card { background: rgba(255, 255, 255, 0.05); border-color: rgba(255, 255, 255, 0.1); }
        .about-feature-card strong { color: #f5f5f7; }
        .about-feature-card p { color: #86868b; }
        .about-close { background: #f5f5f7; color: #000; }
        .about-close:hover { background: #ffffff; }
      }
    </style>
